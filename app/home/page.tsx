...
const colorMap: Record<string, { bg: string; iconBg: string; iconText: string; badge: string; badgeText: string; btn: string; btnHover: string; border: string; accent: string }> = {
  green: {
      ...
      <header className="bg-white border-b border-border shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Sair */}
            <button className="hidden md:flex items-center gap-1 text-xs text-muted-foreground hover:text-red-500 transition-colors font-medium ml-2">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-10">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex gap-4 shrink-0">
              {[
                ...
                <div key={kpi.label} className="bg-white/10 backdrop-blur-sm rounded-xl px-5 py-4 text-center border border-white/10 min-w-[90px]">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Acesse as funcionalidades disponíveis para o seu perfil</p>
          </div>
            ...
            return (
              ...
              >
                ...
                `}>
                  ...
                  `}>
                    Acessar
                    <svg className="w-4 h-4 -translate-x-0.5 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
